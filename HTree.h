...
class HTree{
 public:
  ...
  int HTreeInsert(Point *R, int Tid, Node **Root, int Level, int cascading_splits_allowed, ReinsertItem *reinsertList, int *numItems);
    int HTreeInsert(Point *R, int Tid, Node **Root, int Level){
        return HTreeInsert(R, Tid, Root, Level, 0, NULL, NULL);
    }
