...
class OFNode : public Node {
 public:
  ...
  void ConstructSubtree(OFNode *subtreeNode, int splitnode, int option, DataNode **deleted_child_nodes, int *num_deleted_child_nodes, ReinsertItem *reinsertion_list, int *num_points_in_list);
  ...
  int EliminateEmptyNodes(DataNode **deleted_child_nodes, int num_deleted_child_nodes);
